            ...
            <div class="login-cons-sub">
                <div class="login-item">
                    <div class="login-cons-banner">
                        <img src="../../assets/images/loginBanner.jpg" alt="" width="540" height="500">
                    </div>
                    <div class="login-forms">
                        ...
                        <el-form :model="ruleForm2" ref="ruleForm2" label-width="100px">
                            <div class="login-input-item">
                                ...
                                <input @keyup.enter="submitForm('ruleForm2')" v-model="ruleForm2.loginName" class="login-input1" name="loginName" id="loginName" type="text" placeholder="用户名/邮箱/手机号">
                            </div>
                            <div class="login-input-item">
                                <label class="iconfont icon-suo1"></label>
                                <input @keyup.enter="submitForm('ruleForm2')" v-model="ruleForm2.pwd" class="login-input1" type="password" id="pwd" name="pwd" placeholder="密码">
                            </div>
                            ...
                            <div class="login-input-btn">
                                <el-button type="primary" :disabled="!(ruleForm2.loginName.length && ruleForm2.pwd.length)" :loading="btnloading" @click="submitForm('ruleForm2')">登录</el-button>
                            </div>
                        </el-form>
                    </div>
                </div>
    ...
    export default {
        ...
        methods: {
            ...
            loginErp() {
                ...
                this.$http({
                    method: 'post',
                    url: '/xe-route/xe-rms/login/erp/login',
                    data: {
