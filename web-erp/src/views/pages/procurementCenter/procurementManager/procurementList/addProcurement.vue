    ...
    <!-- {{formData}} -->
        <el-form class="resetForm" :rules="rules"  ref = "formData" :model = "formData" label-width = "92px" :inline="true">
            ...
            <div class="for-itemlis">
                <h4 class="tit-salesApply" v-if="formData.purchOrder"><span class="tips-right">
                ...
                <div>
                    ...
                    <el-form-item prop="storeId" label="仓库">
                        <el-select size="small" style="width: 210px;" v-model="formData.storeId" placeholder="选择仓库" :filterable="true">
                ...
                <div class="u-opera-btnBox" style="margin-top: 20px">
        ...
        <!-- 选择商品 -->
        <div class="reset-dialog reset-dialog02">
            <el-dialog title="选择商品" :visible.sync="dialogVisible02" size="" @close="closeVisible02">
                        ...
                        <el-form :inline="true" :model="formGData" ref="formGData" class="demo-form-inline">
                            ...
                            <el-form-item>
                                <el-button class="xe-button-normal" type="primary" @click="onSubmit(2)">
                                    查询
                                </el-button><el-button class="xe-button-normal"  @click="resetForm('formGData')">
                                    重置
                                </el-button>
                            </el-form-item>
                        </el-form>
            ...
            <el-dialog title="设置商品信息" :visible.sync="dialogVisible03">
                ...
                <el-form :model="formDataNum">
                    ...
                    <el-form-item label="采购数量" :label-width="xeLabelWidth80">
                        <el-input @blur="numberFix($event, 0, 2)" v-model.number="formDataNum.proNum" placeholder="请输入数字" class="zy-input-normal" :maxlength='6' auto-complete="off"></el-input>
                    </el-form-item>
...
export default {
    ...
    created() {
        this.loadqueryStore();
        // 新增是写死的，编辑是带过来不能编辑的
        this.formData.purchType = 2;
        this.formData.purchTypeName = this.purchTypeToText(2);
    },
    methods: {
        onSubmit(type) {
            if (type === 1) {
        ...
        closeVisible02(props) {
            this.formDataNum.proSku = '';
            this.formDataNum.proNum = '';
            this.formDataNum.buyPrice = '';
            this.formDataNum.remark = '';
        ...
        submitForm(formName, checkStatus, purchStatus) {
            ...
            this.$refs[formName].validate((valid) => {
                if (valid) {
                    ...
                    this.$http({
                        method: 'post',
                        url: '/xe-route/xe-erp/purch/insertPurch',
                        data: param
                    }).then((res) => {
    ...
    computed: {
        ...
        proAmount() {
            return parseFloat(this.formDataNum.buyPrice * this.formDataNum.proNum).toFixed(2);
        },
        payTypeList() {
            return payType;
        },
