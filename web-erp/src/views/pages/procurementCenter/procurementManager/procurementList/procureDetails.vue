            ...
            <div class="for-itemlis">
                ...
                <div class="goodsTable">
                    ...
                    <el-table
                        ...
                        <el-table-column prop="proNum" label="计划入库数量" min-width="125">
                            <template scope="props">
                                {{props.row.proNum | numberToText}}
                            </template>
                        </el-table-column>
                        <el-table-column prop="arriveNum" label="已入库数量" min-width="105">
                            <template scope="props">
                                {{props.row.arriveNum | numberToText}}
                            </template>
                        </el-table-column>
                        ...
                        <el-table-column prop="receivedCharges" label="已收货费用" min-width="105">
                            <template scope="props">
                                {{props.row.receivedCharges | priceToText}}
                            </template>
                        </el-table-column>
                        <el-table-column prop="remark" label="商品备注" min-width="95">
                            <template scope="props">
                                {{props.row.remark | noneToText}}
                            </template>
                        </el-table-column>
                    </el-table>
                    <div class="table-below-tips">
                        <el-form-item label="" prop="purchAmount" label-width="50px">
                ...
                <div>
                    <div class="u-next" style="padding: 15px 0 150px;">
                        <!--  -->
                        <el-button type="primary" class="xe-button-normal" v-if="formData.purchStatus === 3 && formData.purchType !== 1" @click="submitForm" :disabled="nextDisabled">异常完成</el-button>
...
export default {
    ...
    methods: {
        ...
        AuditedMethod(checkStatus, call) { // 签订
            let _this = this;
            let params = {};
            // params.checkStatus = checkStatus;
            // params.purchStatus = this.formData.purchStatus;
            params.purchStatus = 5;
            params.purchType = this.formData.purchType;
            ...
            let ajaxUrl = '/xe-route/xe-erp/purch/finishPurch';
            ...
            this.$http({
                ...
                setTimeout(function () {
                    ...
                    _this.$router.push({name: 'procurementListIndex'});
                }, 300);
            }).catch((error) => {
