    ...
    <!-- formData:{{formData}} -->
        ...
        <div  class="reset-dialog dialog_wid340 textare_reset300" >
            <el-dialog title="驳回理由" :visible.sync="rejectdailog">
                <textarea style="height: 118px; width: 300px;" :maxlength="200" v-model="rejectext"></textarea>
...
export default {
    ...
    methods: {
        ...
        AuditedMethod(checkStatus, call) { // 审核通过
            ...
            let ajaxUrl = '';
            if (checkStatus === 3) {
                params.purchRejectReason = this.rejectext;
                ajaxUrl = '/xe-route/xe-erp/supplier/purchReject';
            } else {
                ajaxUrl = '/xe-route/xe-erp/supplier/purchCheck';
            }
            this.$http({
                method: 'post',
                url: ajaxUrl,
