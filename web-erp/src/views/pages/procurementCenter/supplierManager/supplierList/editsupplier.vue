    ...
    <!-- {{formData}} -->
            ...
            <div class="for-itemlis">
                ...
                <div>
                    <el-form-item label="结算周期" prop="settlementCycle" required>
                        ...
                        <el-select style="width: 130px;" v-model="formData.settlementTimeUnit" placeholder="天">
                            <el-option
                ...
                <div>
                    <div class="u-next" style="padding: 15px 0 150px;">
                        <el-button type="primary" class="xe-button-normal" v-if="formData.checkStatusPre > 5 || formData.checkStatusPre < 3 || formData.checkStatusPre === 4" @click="submitForm('formData', 1, 1)" :disabled="nextDisabled">保存</el-button>
                        <el-button class="xe-button-normal" type="primary" @click="submitForm('formData', 2, 2)" :disabled="nextDisabled">保存并提交</el-button>
        ...
        <div class="reset-dialog reset-dialog02">
            <el-dialog title="选择平台商户" :visible.sync="dialogVisible" size="small">
                ...
                <div slot="footer" class="dialog-footer">
                    <el-button type="primary" @click="saveSupplierName()">确定</el-button>
        ...
        <div class="reset-dialog reset-dialog02">
            <el-dialog title="添加联系人" :visible.sync="dialogVisible02" size="small" @close="dialogClose">
                ...
                <div slot="footer" class="dialog-footer">
                    <el-button type="primary" @click="saveLinkman('userList')">确定</el-button>
...
export default {
    data() {
        ...
        let checksettlementCycle = (rule, value, callback) => {
            let values = $.trim(value);
            if (values > 0) {
                callback();
            } else {
        ...
        return {
            ...
            rules: {
                ...
                settlementCycle: [
                    {validator: checksettlementCycle, trigger: 'blur'}
                ...
                // ],
                bankAccName: [
                    {validator: checkaccBank, message: '请输入账户名称', trigger: 'blur'}
                ],
                accBank: [
        ...
        submitForm(formName, checkstatus, supplierStatus) {
            ...
            this.$refs[formName].validate((valid) => {
                if (valid) {
                    ...
                    // supplierCode编辑供货商 code
                    param.supplierCode = this.$route.query.supplierCode;
                    ...
                    this.$http({ // submit
                        method: 'post',
                        url: '/xe-route/xe-erp/supplier/updateSupplier',
                        data: param
                    }).then((res) => {
                        if (res.status === '0000') {
