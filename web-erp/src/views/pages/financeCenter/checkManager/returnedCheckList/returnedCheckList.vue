<template lang="html">
    <div class="m-router-con">
            ...
            <el-table
                ...
                <el-table-column
                    ...
                    <template scope="props">
                        ...
                        <!-- 待提交 -->
                        <!-- 待采购部审核 -->
                        <div class="btn-in-table" v-if="props.row.financeCheckStatus === 1">
                            <a href="javascript:;" class="s-blue" @click="procureDetails(props.row)">查看</a>
                            <a v-if="props.row.afterSaleStatus !== 5" href="javascript:;" class="s-blue" @click="checkoutBtn(props.row)">审核</a>
                        </div>
                        <!-- 待财务部审核 采购部驳回-->
        ...
        <el-dialog title="审核" :visible.sync="rejectdailog"   class="reset-dialog dialog_wid340 textare_reset300" >
            ...
            <textarea v-model="rejectreson" placeholder="请填写售后单的驳回原因50字以内" :maxlength="50" style="width: 300px; height: 118px;"></textarea>
    ...
    export default {
        ...
        methods: {
            ...
            rAjax(n) {
                ...
                this.$http({
                    method: 'post',
                    url: '/xe-route/xe-erp/afterSales/batchAfterSaleByFinance',
                    data: params
                }).then((res) => {
                    console.log(res);
            ...
            procureDetails(row) { // 查看
                this.$router.push({name: 'finalreturnedDetails', query: {afterSalesCode: row.afterSalesCode}});
            },
