    ...
    <div class="editor_body">
        <el-form :inline="true" :model="formsearch" ref="formsearch">
            <el-form-item prop="orderId">
                <el-input size="small" placeholder="订单编号" class="" v-model="formsearch.orderId">
                </el-input>
            </el-form-item>
             <el-form-item prop="proName">
                <el-input size="small" placeholder="商品名称" class="" v-model="formsearch.proName">
                </el-input>
            </el-form-item>
            <el-form-item>
        ...
        <div>
            <el-table ref="payDetails" :data="payDetails" border v-loading ="loading">
                ...
                <el-table-column prop="sendTime" label="发货时间" min-width="150"></el-table-column>
                <!--<el-table-column prop="" label="付款时间" min-width="150"></el-table-column>-->
                ...
                <el-table-column prop="proPrice" label="成交单价" min-width="100">
                    <template scope="scope">
                ...
                <el-table-column prop="profitAmount" label="毛利" min-width="100">
                    <template scope="scope">
...
//                productUrl: ''
    ...
    methods: {
        purchPayList() { // 分页显示对应上个账期未结算的订单明细
            ...
            this.$http({
                method: 'post',
                url: `${this.productUrl}/finPurchPay/queryLastPlatformFinPurchPayDetail`,
                data: params
            }).then((res) => {
                this.loading = false;
