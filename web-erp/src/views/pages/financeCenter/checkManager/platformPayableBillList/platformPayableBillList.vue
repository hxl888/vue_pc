            ...
            <el-form :inline="true" :model="formData" ref="formData1" class="demo-form-inline">
                <el-form-item prop="pbCode">
                 ...
                 <!--<el-form-item label="" prop="reviewStatus">-->
                    ...
                    <!--</el-select>-->
                <!--</el-form-item>-->
                <el-form-item label="" prop="pbStatus" class="z-mr30">
        ...
        <div>
            <el-table
                ...
                <el-table-column
                    ...
                    min-width="130">
                    <template scope="props">
                        <div v-if="props.row.bkgeAmount">
                            {{parseFloat(props.row.bkgeAmount).toFixed(2)}}
                        </div>
                    </template>
                </el-table-column>
                <el-table-column
                            ...
                            <el-table-column
                                ...
                                <template scope="scope">
                                    <!--<div v-if="scope.row.proPayAmount">-->
                                        <!--{{parseFloat(scope.row.proPayAmount).toFixed(2)}}-->
                                    <!--</div>-->
                            ...
                            <el-table-column
                                ...
                                <template scope="scope">
                                    <div v-if="scope.row.bkgeRate">
                                        {{parseFloat(scope.row.bkgeRate).toFixed(2)}}
                                    </div>
                                    <div v-else>0</div>
                                </template>
                            </el-table-column>
...
<script>
    ...
    import {monthFloor, reviewStatus, pbStatus, bkgeSettleWay} from '@/dataControl.js';
...
//                productUrl: ''
        ...
        methods: {
            ...
            toreviewPost(status, obj) { // 复核
                ...
                let _this = this;
                if (status === 1) { // 复核成功
                    URL = '/finPurchPay/platformPayCheckSuccess';
                } else if (status === 2) { // 复核失败
                    URL = '/finPurchPay/platformPayCheckFail';
                }
           ...
           // },
            ...
            xeFinPbillListMethod() { // 我的应付账单列表
                ...
                this.outerUrl = '/xe-route/xe-erp/finance/queryPlatformFinPurchPayExportList?bkgeSettleWay=' + params.bkgeSettleWay + '&cancelStatus=' + params.cancelStatus + '&confirmBill=' + params.confirmBill + '&endDate=' + params.endDate + '&orderId=' + params.orderId + '&pbCode=' + params.pbCode + '&pbMonth=' + params.pbMonth + '&pbStatus=' + params.pbStatus + '&proName=' + params.proName + '&remark=' + params.remark + '&reviewStatus=' + params.reviewStatus + '&startDate=' + params.startDate;
                // mingxi
                this.outerDetailUrl = '/xe-route/xe-erp/finance/queryPlatformFinPurchPayExportDetail?bkgeSettleWay=' + params.bkgeSettleWay + '&cancelStatus=' + params.cancelStatus + '&confirmBill=' + params.confirmBill + '&endDate=' + params.endDate + '&orderId=' + params.orderId + '&pbCode=' + params.pbCode + '&pbMonth=' + params.pbMonth + '&pbStatus=' + params.pbStatus + '&proName=' + params.proName + '&remark=' + params.remark + '&reviewStatus=' + params.reviewStatus + '&startDate=' + params.startDate;
                this.$http({ // 我的应付账单列表
                    method: 'post',
                    url: `${this.productUrl}/finPurchPay/queryPlatformFinPurchPayList`,
                    data: params
                }).then((res) => {
            ...
            purchPayDetail(sbillCode) {
                ...
                this.$http({ // 平台应付款账单明细
                    method: 'post',
                    url: `${this.productUrl}/finPurchPay/queryPlatformFinPurchPayDetail`,
                    data: param
                }).then((res) => {
