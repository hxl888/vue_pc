                ...
                <div class="serch-content">
                    <el-form :inline="true" :model="puboderSerData" label-width ='73px' ref="puboderSerData">
                        ...
                        <div class="clearfix">
                            ...
                            <el-form-item prop="tmsStatus" label="TMS状态">
                                <el-select size="small" class="xe-input-w160" v-model="puboderSerData.tmsStatus" placeholder="请选择">
                                    <el-option
...
<script>
    ...
    import {typeFlag, typeFlag02, orderStatus, tmsStatus, shipType} from '@/dataControl';
    ...
    export default {
        ...
        methods: {
            ...
            enquiryForm(pageNum, formData) {
                ...
                this.outerDetailUrl = '/xe-route/xe-erp/logistics/exLogisticsOrderDetail?caAreaId=' + params.caAreaId + '&caCityId=' + params.caCityId + '&caProvinceId=' + params.caProvinceId + '&endCreateDate=' + params.endCreateDate + '&endSendTime=' + params.endSendTime + '&loginAccount=' + params.loginAccount + '&orderStatus=' + params.orderStatus + '&seacherCar=' + params.seacherCar + '&seacherOrder=' + params.seacherOrder + '&shipType=' + params.shipType + '&startCreateDate=' + params.startCreateDate + '&startSendTime=' + params.startSendTime + '&storeId=' + params.storeId + '&tmsStatus=' + params.tmsStatus + '&typeFlagCar=' + params.typeFlagCar + '&typeFlagOrder=' + params.typeFlagOrder;
                this.$http({
                    method: 'post',
                    url: `/xe-route/xe-erp/logistics/queryOrderLogisticsList`,
                    data: params
                }).then((res) => {
                    this.xePageInfo.total = res.data.xePageInfo.total;
                    this.pubTabDatacon = res.data.orderLogisticsList;
