            ...
            <el-form :inline="true" :model="formData" ref="formData" class="demo-form-inline" label-width="72px">
                <div class="row-search clearfix">
                    <el-form-item label="订单编号">
                        <el-input v-model="formData.orderId" readonly placeholder="调拨单号自动生成" icon="search" @click.native="queryOrder()"></el-input>
                    </el-form-item>
                ...
                <div class="row-search clearfix">
                    ...
                    <!-- <el-form-item prop="orderStatusName" label="订单状态">
                        <el-input v-model="formData.orderStatusName" :disabled="true"></el-input>
                    </el-form-item> -->
                    ...
                    <!-- <el-form-item prop="payTypeName" label="支付类型">
                        <el-input v-model="formData.payTypeName" :disabled="true"></el-input>
                    </el-form-item> -->
                    ...
                    <!-- <el-form-item prop="payStatusName" label="支付状态">
                        <el-input v-model="formData.payStatusName" :disabled="true"></el-input>
                    </el-form-item> -->
                </div>
                <div class="row-search clearfix">
        ...
        <div class="goodsTable serviceTab">
            <el-table
                ...
                <el-table-column label="退款金额" prop="rejectAmount" min-width="85">
                    <template scope="props">
                        <div v-if="formData.afterSaleType < 3">
                    ...
                    <div class="clearfix">
                        ...
                        <div class="">
                            <el-table
                                ...
                                <el-table-column label="退货量" min-width="110">
                                    <template scope="props">
                                        <el-input size="small" @blur="props.row.rejectNum = parseFloat($event.target.value) > 0 ? props.row.rejectNum = parseFloat($event.target.value).toFixed(2) : ''" style="width: 100%;" v-model.number="props.row.rejectNum"></el-input>
                                    </template>
                                </el-table-column>
                                <el-table-column prop="" label="退货退款金额" min-width="110">
                                    <template scope="props">
                                        <div v-if="props.row.rejectNum">
                                            {{ (props.row.proCostPrice - (props.row.pmtAmount + props.row.specialDisamount) / props.row.purchaseNum) * props.row.rejectNum | priceToText}}
                                        </div>
                                    </template>
                                </el-table-column>
                            </el-table>
        ...
        methods: {
            ...
            compilePn(row) {
                ...
                this.$http({        // 售后单详情页面
                    ...
                    this.receiptDetailList = res.data.XeVenAfterSaleInfoView.detailViewList;
                    this.pullDown();
                }).catch((error) => {
                    console.log(error);
                });
            ...
            comfirmInsert() {
                let param = {};
                param = this.formData;
                param.afterSaleCode = this.$route.query.afterSalesCode;
                ...
                this.$http({
                    method: 'post',
                    url: '/xe-route/xe-erp/afterSales/updateAfterSale',
                    data: param
                }).then((res) => {
            ...
            // 选中要勾选的商品
            saveChoosed(type) {
                console.log('testChoose', this.afterSaleInfo);
