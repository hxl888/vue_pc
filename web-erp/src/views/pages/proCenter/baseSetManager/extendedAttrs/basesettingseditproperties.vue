        ...
        <div class="addNew-box basenewprop">
            <el-form :model="addformData" ref="addformData" :rules="rules" :label-width="xeLabelWidth66">
                <el-form-item label="属性名称" prop="typeName">
                    <el-input v-model="addformData.typeName" class="xe-input-col3" :maxlength="20" auto-complete="off"></el-input>
                        ...
                        <el-table
                            ...
                            <el-table-column
                                ...
                                <template scope="scope">
                                    <el-input :maxlength="10" v-model.trim="scope.row.propertyName" @blur="propertyNameck(extendData1)" class="xe-input-smal90" auto-complete="off"></el-input>
                                </template>
                            </el-table-column>
                            <el-table-column
                                prop="key2"
                    ...
                    <div class="extendData">
                        <el-table
                            ...
                            <el-table-column
                                ...
                                width="130">
                                <template scope="scope">
                                    <el-input :maxlength="10" v-model.trim="scope.row.specName" @blur="propertyNameck(extendData2)" class="xe-input-smal90" auto-complete="off"></el-input>
                                </template>
                            </el-table-column>
                            <el-table-column
                                prop="key2"
                ...
                <div class="dialog-footer">
                    <el-button type="primary" :loading="saveLoading" @click="Preservation('addformData')">保存</el-button>
        ...
        methods: {
            editEcho() { // 数据回显
                ...
                if (typeId) {
                    ...
                    this.$http({
                        method: 'post',
                        url: `${this.productUrl}/product/type/queryTypeByTypeId`,
                        data: params
                    }).then((res) => {
                        console.log('----回显!!>', res);
                        if (res.data.remote && res.data.remote.status !== '0000') {
                            window.$wxeMessage(`${res.data.remote.msg}`, {
                                type: 'error'
                            });
                        } else {
                            if (res.data) {
...
//                });
            ...
            submitForm() {
                ...
                this.$http({
                    method: 'post',
                    url: `${this.productUrl}/product/type/updateProType`,
                    data: params
                }).then(res => {
                    console.log(res);
