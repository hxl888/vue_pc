        ...
        <div class="addNew-box reset-dialog reset-dialog02">
            ...
            <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="80px" id="brandRuleForm">
                <el-form-item label="品牌名称" prop='brandName'>
                  <el-input name='brandName' v-model="ruleForm.brandName" class="xe-input-col3" :maxlength="20" auto-complete="off"></el-input>
                    ...
                    <div class="xeUpload">
                        <div class="upload-btn">
                            ...
                            <form name='form1' id='formFile1'>
                                <input type="file"  title="点击添加或修改图片" multiple name='imgFiles' class='inputFile2' @change='inputFile2Fn("formFile1")' accept="image/gif,image/jpeg,image/jpg,image/png">
                            </form>
                ...
                <el-form-item label="" class="text_area">
                    <div class="dialog-footer">
                        <el-button type="primary" @click="submitForm('ruleForm')"  :disabled="submitFlag">保存</el-button>
        ...
        methods: {
            echoDatalist() {
                ...
                if (brandId) {
                    ...
                    this.$http({
                        method: 'post',
                        url: '/xe-route/xe-pro/product/brand/listProBrand.shtml',
                        data: params
                    }).then((res) => {
                        let oldData = res.data.listProBrand[0];
            ...
            validateNameCk(suc, err) { // 校验品牌名称是否重复
                ...
                this.$http({
                    ...
                    if (res.data.remote && res.data.remote.status !== '0000') {
                        console.log('test', res.data.remote);
            ...
            submitForm(formName) {
                ...
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        formData.brandId = this.$route.query.brandId;
                        this.$http({
                            method: 'post',
                            url: '/xe-route/xe-pro/product/brand/updateProBrand.shtml',
                            data: formData
                        }).then((res) => {
                            console.log('----!!>', res);
                            window.$wxeMessage({
