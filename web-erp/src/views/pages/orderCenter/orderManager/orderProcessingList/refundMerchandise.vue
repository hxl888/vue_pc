        ...
        <el-table
            ...
            >
                <template scope="scope">
                    <div v-if="scope.row.purchaseNum">
                        {{(scope.row.purchaseNum * 1000 - (scope.row.realSendNum ? scope.row.realSendNum : 0)*1000)/1000}}
                    </div>
                </template>
            </el-table-column>
            <el-table-column
            ...
            >
                <template scope="scope">
                    ...
                    <!--<div v-if="scope.row.proCostPrice && scope.row.purchaseNum">-->
                        <!--{{parseFloat((scope.row.proCostPrice*100)*(scope.row.purchaseNum*100)/10000).toFixed(2)}}-->
                    <!--</div>-->
                </template>
            </el-table-column>
            <!--<el-table-column-->
            ...
            <el-table-column
                label="操作"
                width="85"
                v-if="refundMer.orderInfoDetail.length > 0 && refundMer.orderInfoDetail[0].payStatus == 2"
                fixed="right">
                <template scope="scope">
                ...
                <div style="padding: 20px 20px 5px">
                    <el-table
                        ...
                        >
                            <template scope="scope">
                                <div>
                                    <el-input size="small"  @blur="checkNum(scope.row.proPayAmount, $event)" @input.native="parseFloatNum($event)" v-model.trim="scope.row.specialDisamounts" type="text" class="xe-input-h24" placeholder=""></el-input>
                                </div>
                            </template>
                        </el-table-column>
                    </el-table>
