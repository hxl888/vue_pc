<template lang="html">
    <div>
        <el-table
            ...
            >
                <template scope="scope">
                    <div v-if="confirmSendNum === 2 && scope.row.purchaseNum">
            ...
            >
                <template scope="scope">
                    ...
                    <!--<div v-if="scope.row.proTotalPrice">-->
                        <!--{{parseFloat((scope.row.proPrice*100)*(scope.row.purchaseNum*100)/10000).toFixed(2)}}-->
                    <!--</div>-->
                </template>
            </el-table-column>
            <el-table-column
            ...
            >
                <template scope="scope">
                    <div v-if="confirmSendNum === 2 && scope.row.proPayAmount">
                        {{parseFloat((scope.row.proPayAmount*100 - (scope.row.differenceAmount ? scope.row.differenceAmount*100 : 0))/100).toFixed(2)}}
                    </div>
                    <div v-else>
                        0
                    </div>
...
<script>
    export default {
        props: ['refundMer', 'confirmSendNum'],
        data() {
            return {
            };
        },
