...
module.exports = {
    build: {
        ...
        assetsPublicPath: 'http://paas-web.xianyiscm.com/',
    ...
    beta: {
        ...
        assetsSubDirectory: 'static',
        assetsPublicPath: 'http://paas-web-beta.xianyiscm.com/',
        productionSourceMap: true,
        // Gzip off by default as many popular static hosts such as
        // Surge or Netlify already gzip all static assets for you.
        // Before setting to `true`, make sure to:
    ...
    test: {
        ...
        assetsSubDirectory: 'static',
        assetsPublicPath: 'http://paas-web-test.xianyiscm.com/',
        productionSourceMap: true,
        // Gzip off by default as many popular static hosts such as
        // Surge or Netlify already gzip all static assets for you.
        // Before setting to `true`, make sure to:
    ...
    devend: {
        ...
        assetsSubDirectory: 'static',
        assetsPublicPath: 'http://paas-web-dev.xianyiscm.com/',
        productionSourceMap: true,
        // Gzip off by default as many popular static hosts such as
        // Surge or Netlify already gzip all static assets for you.
        // Before setting to `true`, make sure to:
    ...
    dev: {
        ...
        proxyTable: {
            '/page': {
                ...
                // target: 'http://192.168.32.196:8001/',
                // target: 'http://192.168.32.216:7010/',
                changeOrigin: true,
                pathRewrite: {
                    '^/page': '/page'
                }
            ...
            '/page/ac': {
                target: 'http://ac-test.xianyiscm.com/',
                changeOrigin: true,
                pathRewrite: {
                    '^/page/ac': '/page/ac'
                }
            ...
            '/ofc': {
                target: 'http://ofc-dev.xianyiscm.com/',
                changeOrigin: true,
                pathRewrite: {
                    '^/ofc': '/ofc'
                }
