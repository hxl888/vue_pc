<template lang="html">
    <div class="m-router-con rseGds-content">
        ...
        <div class="for-itemlis">
            ...
            <div class="item-main-box martop10">
                <ul class="clearfix">
                    ...
                    <li class="list-show list-show1 fl" v-if="auditetailsData.venInfo.venSatatus == 2 || 4"><p class="lis_p ellipsis">审核时间：{{auditetailsData.venInfo.auditDate, 'ms' | millisecondFormat}}</p></li>
                     <el-tooltip class="item" effect="dark" placement="top">
        ...
        <!--对公账号信息-->
        <div class="for-itemlis" v-if="auditetailsData.venInfo.venSatatus == 4">
             <div class="item-head clearfix">
                <div class="fl item-tit">对公账号信息</div>
             </div>
             <div class="item-main-box">
                    <div class="detial-lis"><span class="labels"> 银 行 账 户 名：</span>{{auditetailsData.venInfo.bankAccName}}</div>
                    <div class="detial-lis"><span class="labels">银 行 账 号：</span>{{auditetailsData.venInfo.bankAccCard}}</div>
                    <div class="detial-lis"><span class="labels">开  户  行：</span>{{auditetailsData.venInfo.accBank}}</div>
                    <div class="detial-lis"><span class="labels">开会支行名称：</span>{{auditetailsData.venInfo.subAccBank}}</div>
             </div>
        </div>
          <!--商户性质-->
        <div class="for-itemlis">
                ...
                <div class="detial-lis detial-Img clearfix">
                    ...
                    <p class="fl clearfix">
                        <!--<p class="fl"  v-for="(item, index) in auditetailsData.contractList">-->
                            ...
                            <!--</a>-->
                        <!--</p>-->
                        <p class="fl" v-if="auditetailsData.venInfo.contractType == 1 && auditetailsData.contractList && auditetailsData.contractList.length"><a style="color: #20a0ff"  target="_blank" :href="auditetailsData.contractList[0].contractUrl">合同文件</a></p>
                        <p class="fl"  v-if="auditetailsData.venInfo.contractType == 2 && auditetailsData.contractList && auditetailsData.contractList.length">
