      ...
      <div class="u-top-search">
          <el-form ref="searchform" :model="searchform" :inline="true">
                ...
                <el-form-item prop="keyWords">
                 ...
                 <el-form-item prop="">
                    <el-input size="small" placeholder="请输入用户账号" v-model="searchform.keyWords" class="">
                      </el-input>
                </el-form-item>
            ...
            <div class="advancedSearch" @click.stop>
                ...
                <div class="serch-content">
                    <el-form :inline="true" :model="searchform" ref="searchform" class="demo-form-inline" label-width="73px">
                        ...
                        <div>
                            <el-form-item prop="startDateStr" label="发送时间" class='marR0'>
                                <el-date-picker
                                    size="small"
                                    v-model="value1"
                                    class="xe-input-168"
                        ...
                        <div>
                             <!--<el-form-item prop="" label="用户账号">-->
                                    <!--<el-input size="small" placeholder="请输入用户账号" class="xe-input-168" v-model="searchform.keyWords" class="">-->
                                      <!--</el-input>-->
                            <!--</el-form-item>-->
