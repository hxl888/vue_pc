        ...
        <div class="goodsTable">
                <el-table
                    ...
                    <el-table-column label="商品图片" min-width="95">
                        <template scope="props">
                            <div class="z-imgbox">
                                <img :src=props.row.skuList[0].proMainImg alt="商品图片" width="60" height="60">
                            </div>
                        </template>
                    </el-table-column>
...
//            productUrl: ''
    ...
    methods: {
        ...
        editSpu(row) {
            this.$router.push({name: 'auditeddetai', query: {proSpu: row.proSpu}});
        },
        enquiryForm() {
            let params = {};
            ...
            this.$http({
                ...
                for (let i in this.tableData) {
                    for (let j in this.tableData[i].skuList) {
                        this.tableData[i].skuList[j].proMainImg = picServer + this.tableData[i].skuList[j].proMainImg;
                    }
                }
