    ...
    <div class="m-router-con">
            ...
            <div class="for-itemlis">
                ...
                <div class="form_sub_btn addmargin">
                    <el-button type="primary" @click="AuditedMethod(2)">审核通过</el-button>
                    <el-button @click="rejectdailog = true">驳回</el-button>
...
//                        console.log('proSkuSpecList.length-->', this.tableData[this.maxcolumnNum].proSkuSpecList);
        ...
        AuditedMethod(status, call) { // 审核通过
            let params = {};
            params.proSpus = this.$route.query.proSpu;
            params.proStatus = status;
            params.rejectReason = this.rejectext;
            this.$http({
                method: 'post',
