<template lang="html">
    <div class="m-router-con">
                    ...
                    <el-form :inline="true" label-width ='73px'  :model="searchform" ref="searchform" class="demo-form-inline">
                        <div>
                            <el-form-item prop="proName" label="商品名称">
                                <el-input class="xe-input-168" v-model="searchform.proName" placeholder="商品名称"></el-input>
                            </el-form-item>
                            <el-form-item prop="venName" label="商户名称">
                                <el-input class="xe-input-168"  v-model="searchform.venName" placeholder="商户名称"></el-input>
                            </el-form-item>
                        </div>
                        <div>
                            <el-form-item prop="proNum" label="商品货号">
                                <el-input class="xe-input-168"   v-model="searchform.proNum" placeholder="商品货号"></el-input>
                            </el-form-item>
                            <el-form-item prop="venAccount" label="商户账号">
                                <el-input class="xe-input-168"   v-model="searchform.venAccount" placeholder="商户账号"></el-input>
                            </el-form-item>
                        </div>
                        <div>
                            <el-form-item prop="spuSkuNum" label="商品编号">
                                <el-input class="xe-input-168"   v-model="searchform.spuSkuNum" placeholder="商品编号"></el-input>
                            </el-form-item>
                            <el-form-item prop="shopName" label="店铺名称">
                                <el-input class="xe-input-168"   v-model="searchform.shopName" placeholder="店铺名称"></el-input>
                            </el-form-item>
                        </div>
                        <div>
                            ...
                            <el-form-item prop="priceMethod" label="定价方式">
                                <el-select v-model="searchform.priceMethod" class="xe-input-168"  placeholder="定价方式">
                                    <el-option
                                      v-for="item in priceMethodlist"
                                      :key="item.value"
                                      :label="item.name"
                            ...
                            <div>
                                <el-form-item prop="frozenFlag" label="是否冻品">
                                    <el-select v-model="searchform.frozenFlag" class="xe-input-168" placeholder="是否冻品">
                                        <el-option
        ...
        <div class="u-opera-btnBox" >
            <el-button @click="shenheAll">
                <span class="iconfont icon-shenhe"></span> 审核
            </el-button>
            <!--<el-button>-->
        ...
        <div class="goodsTable">
                <el-table
                    ...
                    <el-table-column label="商品图片" min-width="95">
                        <template scope="props">
                            <div class="z-imgbox">
                                <img :src="picServer + props.row.skuList[0].proMainImg"  alt="" width="60" height="60">
                            </div>
                        </template>
                    </el-table-column>
                    ...
                    <el-table-column label="审核状态" prop="proStatus" min-width="130">
                        <template scope="scope">
...
//            productUrl: ''
    ...
    methods: {
        ...
        editSpu(row) {
            this.$router.push({name: 'checkpenddetail', query: {proSpu: row.proSpu}});
        },
        AuditedMethod() { // 审核通过
            let params = {};
            let _this = this;
            ...
            for (let i in this.selectedArray) {
                selecString.push(this.selectedArray[i].proSpu);
            }
            console.log('selecString', selecString);
            params.proStatus = 2;
            params.proSpus = selecString.join(',');
            this.$http({
                method: 'post',
                url: `${this.productUrl}/manager/proAudit/auditOrCanalePro`,
                data: params
            }).then((res) => {
                window.$wxeMessage({
                    message: `${res.msg}`,
        ...
        enquiryForm() {
            ...
            this.$http({
                method: 'post',
                url: `${this.productUrl}/manager/proAudit/listVenProAuditData`,
                data: params
            }).then((res) => {
                console.log('----!!>', res);
