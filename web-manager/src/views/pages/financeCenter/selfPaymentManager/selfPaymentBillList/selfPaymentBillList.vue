<template lang="html">
    <div class="m-router-con">
                    ...
                    <el-form :inline="true"  label-width ='73px' :model="searchform" ref="searchform" class="demo-form-inline">
                        ...
                        <div  class="clearfix">
                             ...
                             <el-form-item prop="remark" label="供应商名称">
                                <el-input size="small"style="width: 168px"  placeholder="供应商名称" v-model="searchform.remark">
                                  </el-input>
                            </el-form-item>
                        ...
                        <div  class="clearfix">
                            ...
                            <el-form-item prop="purchSettleWay"   label="结算方式">
                                <el-select size="small" style="width: 168px" v-model="searchform.purchSettleWay" placeholder="结算方式">
                                        <el-option
        ...
        <div class="u-opera-btnBox">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;<span style="color: #008000;font-size: 16px" v-if="xeFinPbillList && xeFinPbillList.length">冻品自营经销商（{{xeFinPbillList[0].shopName}}）</span>
        </div>
        <div>
            <el-table ref="xeFinPbillList" :data="xeFinPbillList" border v-loading="dataListloading" @selection-change="handleSelectionChange">
                ...
                <el-table-column prop="remark" label="供应商名称" min-width="150">
                </el-table-column>
                <!--<el-table-column prop="" label="店铺名称" min-width="150">-->
                <!--</el-table-column>-->
                ...
                <el-table-column prop="profitAmount" label="本期毛利合计" min-width="150">
                    <template scope="scope">
                ...
                <el-table-column prop="purchSettleWay" label="结算方式" min-width="100">
                    <template scope="scope">
                        <div v-if="scope.row.purchSettleWay">
                            {{scope.row.purchSettleWay | purchSettleWayfiter}}
                        </div>
                    </template>
                </el-table-column>
        ...
        <el-dialog :title="pbcodeTit" :visible.sync="fillScreendilog" class="reset-dialog reset-dialogScreeen">
            <div style="padding: 20px">
                ...
                <refund-journal :payDetails = 'payDetails'  :paypbStatus="paypbStatus" :seleSure="seleSure" :confirmBillStatus="confirmBillStatus" @seletChangeDetails="seletChangeDetails" @confirmPbillsucess="confirmPbillsucess"></refund-journal>
            </div>
        </el-dialog>
    </div>
</template>
...
<script>
import { confirmBill, pbStatus, monthFloor, reviewStatus, cancelStatus, purchSettleWay } from '@/dataControl';
...
//                                    let pbStatus = _this.detailsData.allLen === _this.detailsData.selectedArray.length ? 3 : 2; // 单个结账 全选3 部分选2
        ...
        finishPbillPost(status, payBillCode, payBillDetailList, pbStatus, userCode, payAmount) {
            ...
            this.$http({
                method: 'post',
                url: `${this.productUrl}/manager/finPbillSelf/finishPbill`,
                data: params
            }).then((res) => {
        ...
        cancelPbillPost(obj) {
            ...
            this.$http({
                method: 'post',
                url: `${this.productUrl}/manager/finPbillSelf/cancelPbill`,
                data: params
            }).then((res) => {
                if (res.data.code === '3000') {
                    setTimeout(() => {
        ...
        listFinPayDetail(pbCode, pbType, userCode, confirmBillStatus, pbStatus, cancelStatus) { // 平台应付管理--应付款账单明细
            ...
            this.$http({
                method: 'post',
                url: `${this.productUrl}/manager/finPbillSelf/listFinPayDetail`,
                data: params
            }).then((res) => {
        ...
        listSysFinBkg() {
            ...
            this.$http({
                method: 'post',
                url: `${this.productUrl}/manager/finPbillSelf/listSysFinBkg`,
                data: params
            }).then((res) => {
        ...
        exportDataMethod() { // 导出
            window.open(`${this.productUrl}/manager/finPbillSelf/exportSysFinBkg?${this.exportData}`);
        },
        exportPayBillDetail() { // 导出明细
            window.open(`${this.productUrl}/manager/finPbillSelf/exportPayBillDetail?${this.exportData}`);
        }
    },
    computed: {
        confirmBillList() {
