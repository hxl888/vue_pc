<template lang="html">
    <div class="refundJournal" style="padding-bottom: 50px;background: #fff">
       <el-table
        :data="payDetails"
        border
        :max-height="400"
        ...
        style="width: 100%">
            ...
            <el-table-column
                ...
                min-width="100">
                <template scope="scope">
                    <div v-if="scope.row.bkgeRate">{{parseFloat(scope.row.bkgeRate).toFixed(2)}}</div>
                    <div v-else>0</div>
                </template>
            </el-table-column>
            <el-table-column
            ...
            <el-table-column
                ...
                min-width="100">
                <template scope="scope">
                    <div v-if="scope.row.refundAmount">{{parseFloat(scope.row.refundAmount).toFixed(2)}}</div>
                    <div v-else>0</div>
                </template>
            </el-table-column>
            <el-table-column
        ...
        methods: {
            ...
            submit() {
                ...
                if (flag) {
                    ...
                    this.$alert('实际付款金额"不能为空或者小于0的数字"', {
                        type: 'info'
                    });
                }
            }
