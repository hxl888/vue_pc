    ...
    export default {
        ...
        methods: {
            queryActionTree() {
                this.$http({
                    methods: 'post',
                    url: '/xe-route/xe-rms/oauth/sys/queryActionTree',
                    data: {}
                }).then(res => {
                    console.log(res);
                    this.loading = false;
            ...
            queryShare(event, store, data) {
                ...
                this.$http({
                    method: 'post',
                    url: '/xe-route/xe-rms/oauth/sys/queryShareActionList',
                    data: {
                        acId: data.acId
                    }
                }).then(res => {
            ...
            shareAdd() {
                ...
                this.$http({
                    method: 'post',
                    url: '/xe-route/xe-rms/oauth/sys/addShareAction',
                    data: {
            ...
            setShare(event, store, data) {
                ...
                if (data.shareFlag === 1) {
                    ...
                    this.$http({
                        method: 'post',
                        url: '/xe-route/xe-rms/oauth/sys/shareAction',
                        data: {
                            acId: data.acId
                        }
                    }).then(res => {
                    ...
                    this.$http({
                        method: 'post',
                        url: '/xe-route/xe-rms/oauth/sys/cancelShareAction',
                        data: {
                            acId: data.acId
                        }
                    }).then(res => {
            ...
            addAction(fn) {
                ...
                this.$http({
                    method: 'post',
                    url: '/xe-route/xe-rms/oauth/sys/addAction',
                    data: this.ruleForm
                }).then(res => {
                    console.log(res);
            ...
            modifyAction(id, fn) {
                ...
                this.$http({
                    method: 'post',
                    url: '/xe-route/xe-rms/oauth/sys/modifyAction',
            ...
            delAction(id, fn) {
                ...
                this.$http({
                    method: 'post',
                    url: '/xe-route/xe-rms/oauth/sys/delAction',
                    data: {
                        acId: id
                    }
                }).then(res => {
            ...
            queryAction(id, fn) {
                ...
                this.$http({
                    method: 'post',
                    url: '/xe-route/xe-rms/oauth/sys/queryAction',
                    data: {
                        acId: id
                    }
                }).then(res => {
