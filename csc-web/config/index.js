...
module.exports = {
    build: {
        ...
        assetsPublicPath: 'http://paas-web.xianyiscm.com/csc/',
    ...
    beta: {
        ...
        assetsSubDirectory: 'static',
        assetsPublicPath: 'http://paas-web-beta.xianyiscm.com/csc/',
        productionSourceMap: true,
        // Gzip off by default as many popular static hosts such as
        // Surge or Netlify already gzip all static assets for you.
        // Before setting to `true`, make sure to:
    ...
    test: {
        ...
        assetsSubDirectory: 'static',
        assetsPublicPath: 'http://paas-web-test.xianyiscm.com/csc/',
        productionSourceMap: true,
        // Gzip off by default as many popular static hosts such as
        // Surge or Netlify already gzip all static assets for you.
        // Before setting to `true`, make sure to:
    ...
    devend: {
        ...
        assetsSubDirectory: 'static',
        assetsPublicPath: 'http://paas-web-dev.xianyiscm.com/csc/',
        productionSourceMap: true,
        // Gzip off by default as many popular static hosts such as
        // Surge or Netlify already gzip all static assets for you.
        // Before setting to `true`, make sure to:
    ...
    dev: {
        ...
        proxyTable: {
            '/page/csc': {
                target: 'http://192.168.28.82/',
                // target: 'http://192.168.32.228:7007/',
                // target: 'http://192.168.24.115:7007/',
                changeOrigin: true,
                pathRewrite: {
                    '^/page/csc': '/page/csc'
                }
