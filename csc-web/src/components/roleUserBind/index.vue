        ...
        <div class="role-box-left">
            ...
            <div>
                <select class= "role-list-select" multiple="multiple" @click="leftSelect">
                    <option class="role-list-option" v-for = "item in leftOptionData" :value="item.id">{{item.userName}}</option>
                </select>
            </div>
        </div>
        <div class="role-box-right">
            ...
            <div>
                <select class= "role-list-select" multiple="multiple" @click="rightSelect">
                    <option class="role-list-option" v-for = "item in rightOptionData" :value="item.id">{{item.userName}}</option>
                </select>
            </div>
        </div>
    </div>
