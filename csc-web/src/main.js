...
Vue.prototype.$http.defaults.baseURL = projectLink.cscApiBaseUrl;
                ...
                switch (userInfo.userStatus) {
                    ...
                    case '400' :
                        ...
                        if (!window.localStorage.getItem('menuList')) {
                            Vue.prototype.$http({
                                method: 'POST',
                                url: projectLink.apiBaseUrl + '/page/uam/menu/main/findAllMenuInfoByCurrentUser'
                            }).then(res => {
